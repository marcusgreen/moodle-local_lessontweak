...
$string['enabletimetracking_desc'] = 'Records how long students actively view each lesson page (a heartbeat that only counts visible time). Stored in this plugin\'s own table and shown in the time report (and the confidence report); it does not affect the lesson grade.';
...
$string['timerbar'] = 'Show a depleting bar';
$string['timerbar_help'] = 'For countdown mode, show a bar alongside the clock that shrinks as the remaining time runs out. Turns amber in the last minute and empties at zero.';
...
$string['timereport'] = 'Time report';
$string['timestudent'] = 'Student';
$string['timeattempt'] = 'Attempt';
$string['timepage'] = 'Page';
$string['timespentcol'] = 'Active time';
$string['timewall'] = 'Attempt duration';
$string['timeupdated'] = 'Updated';
$string['timetotal'] = 'Total for attempt';
$string['timenodata'] = 'No page time has been recorded for this lesson yet.';
$string['timepagegone'] = 'Deleted page (id {$a})';
